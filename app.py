...
#base_model_path = 'JCTN/fav_models/juggernautXL_v8Rundiffusion.safetensors'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default='https://huggingface.co/JCTN/fav_models/resolve/main/juggernautXL_v8Rundiffusion.safetensors?download=true', help='Base model path')
    ...
    # If no argument is provided, it defaults to 'JCTN/fav_models/juggernautXL_v8Rundiffusion.safetensors'
